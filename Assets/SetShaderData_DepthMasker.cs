...
public class SetShaderData_DepthMasker : MonoBehaviour {
	...
	void Update () {
        ...
        Vector3 pos = new Vector3(p1.transform.position.x, p1.transform.position.y, p1.transform.position.z - height);
        renderer.material.SetVector("_P1Pos", pos);

        //p2
        pos = new Vector3(p2.transform.position.x, p2.transform.position.y, p2.transform.position.z - height);
