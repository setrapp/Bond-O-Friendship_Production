...
//       // }
//        if ((controlScheme == Globals.ControlScheme.KeyboardSharedLeft || controlScheme == Globals.ControlScheme.KeyboardSharedRight) && (otherPlayerControlScheme != Globals.ControlScheme.KeyboardSharedLeft && otherPlayerControlScheme != Globals.ControlScheme.KeyboardSharedRight))
//        {
//           // if (playerNumber == Player.Player1)
...
//        if(playerNumber == Player.Player1)
//            device = Globals.Instance.leftControllerIndex >= 0 ? InputManager.Devices[Globals.Instance.leftControllerIndex] : null;
//        if (playerNumber == Player.Player2)
//            device = Globals.Instance.rightContollerIndex >= 0 ? InputManager.Devices[Globals.Instance.rightContollerIndex] : null;
//       // Debug.Log(Globals.Instance.player2Device);
//        if(device != null)
//        {
...
//        if(playerNumber == Player.Player1)
//        {
//            if(Globals.Instance.leftControllerIndex == -2)
//            {
//                //Debug.Log("Here 1");
//                device = InputManager.ActiveDevice;

//                if(InputManager.Devices.IndexOf(device) != Globals.Instance.rightContollerIndex)
//                {
...
//        {
//           // Debug.Log("Here 2");
//            if (Globals.Instance.rightContollerIndex == -2)
//            {
//                device = InputManager.ActiveDevice;
//               // Debug.Log(InputManager.Devices.IndexOf(device));
//                if (InputManager.Devices.IndexOf(device) != Globals.Instance.leftControllerIndex)
//                {
//                    if (InputManager.Devices.IndexOf(device) == Globals.Instance.player2PreviousDevice && !allowPreviousController)
//                    {
//                    }
//                    else
//                    Globals.Instance.rightContollerIndex = InputManager.Devices.IndexOf(device);
//                }
//            }
//        }
//    }
...
//                    {
//                        Globals.Instance.leftControllerIndex = -1;
...
//                       // if(Globals.Instance.player2ControlScheme == Globals.ControlScheme.KeyboardSolo)
...
//                    if (InputManager.controllerCount < 2)
//                    {
//                        Globals.Instance.rightContollerIndex = -1;
//                        //Globals.Instance.player2ControlScheme = Globals.ControlScheme.KeyboardSharedRight;
